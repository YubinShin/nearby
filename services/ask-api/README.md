...
`scripts/eval/golden_set.yaml` 에 질의 25개와 정답 339건이 있습니다 (2026-08-05 라벨링).
...
| 채널 | precision@10 | recall@10 | MRR | nDCG@10 |
|---|---:|---:|---:|---:|
...
`scripts/eval/scores/2026-08-05-*.json` 이고 위 명령으로 재현합니다.
