val serviceModules = listOf("search-core", "search-api", "indexer-batch", "indexer-stream")

tasks.register("build") {
	group = "build"
	description = "services 4개 모듈과 KOMORAN 분석 플러그인을 빌드합니다."
...
tasks.register("test") {
	group = "verification"
	description = "services 4개 모듈의 테스트를 실행합니다."
